...
You will need a firebaseKeys.json at `src/service/firebaseKeys.json`
...
Ask Otacilio Maia to get the file or check your whatsapp (if you're michael).

To reset the aplication and go back to onboard, open the browser console and type:

> localStorage.clear()

than reload de browser
